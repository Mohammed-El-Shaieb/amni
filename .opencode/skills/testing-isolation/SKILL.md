...
description: Repo testing guidance — unit, integration, ERPNext integration, and tenant-isolation suites. Use when writing tests for new features (especially ERP-backed endpoints) or validating authorization and tenant-scoping logic.
---

---
name: provisioning
description: Provisioning state machine guidance for this repo — idempotency, BullMQ worker jobs, ProvisioningJob model, and safe retries. Use when editing provisioning steps, state machine logic, job retries, or apps/worker code.
---
